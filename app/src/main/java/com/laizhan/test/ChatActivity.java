...
public class ChatActivity extends BaseActivity {
    ...
    private void sendOrderOrTrack() {
        ...
        if (bundle != null) {
            //检查是否是从某个商品详情进来
            String orderInfo = bundle.getString(Constant.ORDER_INFO, null);
            if (orderInfo != null){
     ...
     * @param orderInfo
     */
    private void sendOrderMessage(String orderInfo){
        Message message = Message.createTxtSendMessage("", toChatUsername);
        message.addContent(DemoMessageHelper.createOrderInfo(this, orderInfo));
